...
#[tokio::test]
async fn gateway_executes_openai_chat_gemini_cross_format_stream_via_local_stream_rewrite() {
        ...
        .route(
            ...
            any(|_request: Request| async move {
                Json(json!({
                    ...
                    "auth_context": {
                        "user_id": "user-openai-chat-stream-gemini-xfmt-direct-123",
                        "api_key_id": "key-openai-chat-stream-gemini-xfmt-direct-123",
                        "access_allowed": true
                    },
        ...
        .route(
            ...
            any(|_request: Request| async move {
                Json(json!({
                    ...
                    "request_id": "req-openai-chat-stream-gemini-xfmt-direct-123",
                    "candidate_id": "cand-openai-chat-stream-gemini-xfmt-direct-123",
                    "provider_name": "gemini",
                    "provider_id": "provider-openai-chat-stream-gemini-xfmt-direct-123",
                    "endpoint_id": "endpoint-openai-chat-stream-gemini-xfmt-direct-123",
                    "key_id": "key-openai-chat-stream-gemini-xfmt-direct-123",
    ...
    let executor = Router::new().route(
        ...
        any(|_request: Request| async move {
            let gemini_stream = concat!(
                "data: {\"responseId\":\"resp_gemini_stream_123\",\"candidates\":[{\"content\":{\"parts\":[{\"text\":\"Hello \"}],\"role\":\"model\"},\"index\":0}],\"modelVersion\":\"gemini-2.5-pro-upstream\"}\n\n",
                "data: {\"responseId\":\"resp_gemini_stream_123\",\"candidates\":[{\"content\":{\"parts\":[{\"text\":\"Gemini Chat\"}],\"role\":\"model\"},\"finishReason\":\"STOP\",\"index\":0}],\"modelVersion\":\"gemini-2.5-pro-upstream\",\"usageMetadata\":{\"promptTokenCount\":1,\"candidatesTokenCount\":2,\"totalTokenCount\":3}}\n\n"
            );
            let frames = format!(
                concat!(
    ...
    let response = reqwest::Client::new()
        ...
        .header(
            TRACE_ID_HEADER,
            "trace-openai-chat-stream-gemini-xfmt-direct-123",
        )
    ...
    assert!(response_text.contains("\"content\":\"Gemini Chat\""));
...
#[tokio::test]
async fn gateway_executes_openai_chat_gemini_cross_format_function_call_stream_via_local_stream_rewrite(
) {
    use base64::Engine as _;
        ...
        .route(
            ...
            any(|_request: Request| async move {
                Json(json!({
                    ...
                    "executor_candidate": true,
                    "auth_context": {
                        "user_id": "user-openai-chat-stream-gemini-tool-xfmt-direct-123",
                        "api_key_id": "key-openai-chat-stream-gemini-tool-xfmt-direct-123",
                        "access_allowed": true
                    },
                    "public_path": "/v1/chat/completions"
                }))
        ...
        .route(
            ...
            any(|_request: Request| async move {
                Json(json!({
                    "action": "executor_stream_decision",
                    "decision_kind": "openai_chat_stream",
                    "request_id": "req-openai-chat-stream-gemini-tool-xfmt-direct-123",
                    "candidate_id": "cand-openai-chat-stream-gemini-tool-xfmt-direct-123",
                    "provider_name": "gemini",
                    "provider_id": "provider-openai-chat-stream-gemini-tool-xfmt-direct-123",
                    "endpoint_id": "endpoint-openai-chat-stream-gemini-tool-xfmt-direct-123",
                    "key_id": "key-openai-chat-stream-gemini-tool-xfmt-direct-123",
                    "upstream_base_url": "https://generativelanguage.googleapis.com",
                    "upstream_url": "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-pro-upstream:streamGenerateContent?alt=sse",
                    "auth_header": "x-goog-api-key",
                    "auth_value": "upstream-key",
    ...
    let executor = Router::new().route(
        ...
        any(|_request: Request| async move {
            let gemini_stream = concat!(
                "data: {\"responseId\":\"resp_gemini_chat_tool_stream_123\",\"candidates\":[{\"content\":{\"parts\":[{\"text\":\"Need a tool.\"},{\"functionCall\":{\"name\":\"get_weather\",\"args\":{\"city\":\"SF\"}}}],\"role\":\"model\"},\"finishReason\":\"STOP\",\"index\":0}],\"modelVersion\":\"gemini-2.5-pro-upstream\"}\n\n"
            );
            let frames = format!(
                concat!(
                    "{{\"type\":\"headers\",\"payload\":{{\"kind\":\"headers\",\"status_code\":200,\"headers\":{{\"content-type\":\"text/event-stream\"}}}}}}\n",
    ...
    let response = reqwest::Client::new()
        ...
        .header(
            TRACE_ID_HEADER,
            "trace-openai-chat-stream-gemini-tool-xfmt-direct-123",
        )
        .body("{\"model\":\"gpt-5\",\"messages\":[],\"stream\":true}")
        .send()
        .await
