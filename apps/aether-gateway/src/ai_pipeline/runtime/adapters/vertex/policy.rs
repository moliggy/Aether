...
pub(crate) fn supports_local_vertex_api_key_gemini_transport(
...
pub(crate) fn supports_local_vertex_api_key_gemini_transport_with_network(
    transport: &GatewayProviderTransportSnapshot,
) -> bool {
    supports_local_vertex_api_key_same_format_transport(
        transport,
...
pub(crate) fn supports_local_vertex_api_key_imagen_transport(
    transport: &GatewayProviderTransportSnapshot,
) -> bool {
    supports_local_vertex_api_key_same_format_transport(transport, &["gemini:chat"], false)
}

pub(crate) fn supports_local_vertex_api_key_imagen_transport_with_network(
    transport: &GatewayProviderTransportSnapshot,
) -> bool {
